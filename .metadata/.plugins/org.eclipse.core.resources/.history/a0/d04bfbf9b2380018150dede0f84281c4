...
/**
 * Constructor for Class Matrix with random generated values for Matrix
...
//	/* random initialization of the new array */
//	std::random_device rd{};
//	std::mt19937 gen{rd()};
//
//	/* gaussian distribution mean and std_dev */
